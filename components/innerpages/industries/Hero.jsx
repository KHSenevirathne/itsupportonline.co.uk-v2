                    ...
                    <div className="section-inner panel mt-2 sm:mt-4 lg:mt-0">
                        ...
                        >
                            ...
                            <p className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70">
                                With comprehensive expertise across IT and communications, cloud, cyber security and business intelligence, we’ll cover all your technology needs. Whether you choose to fully outsource or complement in-house resources – we provide a complete managed solution from initial advice to supply, implementation and ongoing support.
                            </p>
                        </div>
                            ...
                            {industries.map((industry, index) => (
                                ...
                                >
                                    <div className="row child-cols col-match justify-between g-4 lg:g-8 xl:g-10">
                                        {/* Image section - order switches based on even/odd index */}
                                        <div className={`order-0 ${index % 2 === 0 ? 'lg:order-1' : 'lg:order-0'}`}>
                                        ...
                                        {/* Details section - order switches based on even/odd index */}
                                        <div className={`order-1 ${index % 2 === 0 ? 'lg:order-0' : 'lg:order-1'} col-12 sm:col-5`}>
                                            <div className="panel vstack justify-center gap-4 h-100">
                                                <div>
                                                    <div className="panel vstack gap-2">
                                                        ...
                                                        <h3 className="h4 lg:h2 m-0">{industry.title}</h3>
