                            ...
                            <div data-anime="onview: -100; translateX: [-48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: 100;">
                                <figure className="featured-image m-0 rounded ratio ratio-1x1 overflow-hidden rounded-1-5 lg:rounded-2 lg:rounded-bottom-end-0">
                                    <Image
                                        ...
                                        alt="image title"
                                        src="/assets/images/template/services-10.webp"
                                        width="1200"
                                        height="1200"
                                    />
                                </figure>
                            ...
                            <div data-anime="onview: -100; translateX: [48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: 200;">
                                ...
                                >
                                    ...
                                    <p className="fs-6 lg:fs-5">
                                        A reliable and secure network is the foundation of any successful business. At ClickDo IT, our Network Management and Monitoring service ensures that your network infrastructure operates at peak performance, keeping your business connected and productive. We take a proactive approach to network management, identifying and resolving issues before they impact your operations.
                                    </p>
                                ...
                                <div className="row child-cols col-match justify-between g-4 lg:g-8 xl:g-10">
                                    <div className="order-0 lg:order-1">
                                        <div className="panel w-100 rounded lg:rounded-2 overflow-hidden">
                                            <Image
                                                src="/assets/images/template/services-10-inner.webp"
                                                width={780}
                                                height={728}
                                            ...
                                            <div>
                                                <div className="panel vstack gap-2">
                                                    ...
                                                    <p className="fs-6 lg:fs-5 opacity-70 dark:opacity-80">
                                                        Our service also includes detailed reporting and analytics, giving you visibility into your network’s performance. We provide insights into traffic patterns, security events, and system health, helping you make informed decisions about your IT strategy. With ClickDo IT, you can trust that your network is in expert hands.
                                                    </p>
