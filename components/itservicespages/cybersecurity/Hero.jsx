...
import { cybersecurityitems } from "@/data/faq";
                            ...
                            <div data-anime="onview: -100; translateX: [-48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: 100;">
                                <figure className="featured-image m-0 rounded ratio ratio-1x1 overflow-hidden rounded-1-5 lg:rounded-2 lg:rounded-bottom-end-0">
                                    <Image
                                        ...
                                        alt="image title"
                                        src="/assets/images/template/services-02.webp"
                                        width="1200"
                                        height="1200"
                                    />
                                </figure>
                            ...
                            <div data-anime="onview: -100; translateX: [48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: 200;">
                                ...
                                >
                                    ...
                                    <p className="fs-6 lg:fs-5">
                                        In the digital age, where technology rapidly evolves and business landscapes are continuously reshaped, managed IT services have emerged as a cornerstone for organizational success.aIn the digital age, where technology rapidly evolves and business landscapes are continuously reshaped, managed IT services have emerged as a cornerstone for organizational success.
                                    </p>
                                    <div className="panel w-100 mt-2 lg:mt-4">
                                        ...
                                        >
                                           <Accordion2 items = {cybersecurityitems} />
                                        </ul>
                                    </div>
                                ...
                                <div className="row child-cols col-match justify-between g-4 lg:g-8 xl:g-10">
                                    <div className="order-0 lg:order-1">
                                        <div className="panel w-100 rounded lg:rounded-2 overflow-hidden">
                                            <Image
                                                src="/assets/images/template/services-02-inner.webp"
                                                width={780}
                                                height={728}
                                        ...
                                        <div className="panel vstack justify-center gap-4 h-100">
                                            <div>
                                                <div className="panel vstack gap-2">
                                                    <h3 className="h4 lg:h2 m-0">Why Choose IT Support Online for Cybersecurity?</h3>
                                                    <p className="fs-6 lg:fs-5 opacity-70 dark:opacity-80">
                                                    As a leading provider, IT Support Online excels in delivering comprehensive Cybersecurity services that cater to the unique needs of businesses across various industries.
                                                    </p>
