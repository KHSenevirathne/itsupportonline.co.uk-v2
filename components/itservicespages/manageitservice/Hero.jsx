                            ...
                            <div data-anime="onview: -100; translateX: [48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: 200;">
                                ...
                                >
                                    ...
                                    <p className="fs-6 lg:fs-5">
                                        Managed IT services involve delegating IT operations and management to a third-party provider.
                                        This approach covers a broad spectrum of services, including network management, data backup and recovery, cybersecurity, cloud computing, and end-user support.
                                        By adopting managed IT services, businesses can enjoy several benefits.
                                    </p>
                                    <div className="panel w-100 mt-2 lg:mt-4">
                                        ...
                                        >
                                            <Accordion2 items = {manageitserviceitems} />
                                        </ul>
                                    </div>
