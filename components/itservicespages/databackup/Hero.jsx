                        ...
                        <div className="row child-cols-12 lg:child-cols-6 col-match items-center g-0">
                            <div data-anime="onview: -100; translateX: [-48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: 100;">
                                <figure className="featured-image m-0 rounded ratio ratio-1x1 overflow-hidden rounded-1-5 lg:rounded-2 lg:rounded-bottom-end-0">
                                    <Image
                                        ...
                                        alt="image title"
                                        src="/assets/images/template/services-09.webp"
                                        width="1200"
                                        height="1200"
                                    />
                                </figure>
                            ...
                            <div data-anime="onview: -100; translateX: [48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: 200;">
                                ...
                                >
                                    ...
                                    In today’s digital world, your business data is one of your most valuable assets. At ClickDo IT, we offer comprehensive Data Backup and Recovery services to protect your critical information from loss due to hardware failures, cyberattacks, or natural disasters. Our goal is to ensure that your business can recover quickly and efficiently, minimizing downtime and maintaining operational continuity.
                                    </p>
                                ...
                                <div className="row child-cols col-match justify-between g-4 lg:g-8 xl:g-10">
                                    <div className="order-0 lg:order-1">
                                        <div className="panel w-100 rounded lg:rounded-2 overflow-hidden">
                                            <Image
                                                src="/assets/images/template/services-09-inner.webp"
                                                width={780}
                                                height={728}
                                        ...
                                        <div className="panel vstack justify-center gap-4 h-100">
                                            <div>
                                                <div className="panel vstack gap-2">
                                                    ...
                                                    Security is at the core of our Data Backup and Recovery service. We use advanced encryption to protect your data during storage and transfer, ensuring that it remains safe from unauthorized access. Additionally, our solutions comply with industry standards and regulations, such as GDPR, to keep your business compliant.
                                                    </p>
