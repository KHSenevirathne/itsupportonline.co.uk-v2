                        ...
                        <div className="row child-cols-12 lg:child-cols-6 col-match items-center g-0">
                            ...
                            <div data-anime="onview: -100; translateX: [48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: 200;">
                                ...
                                >
                                    ...
                                    Empowering UK Businesses with Seamless Flexibility
                                    </h3>
                                    <p className="fs-6 lg:fs-5">
                                    In today’s fast-evolving business landscape, remote working has shifted from a temporary fix to a permanent strategy for many UK companies. Whether driven by employee demand, cost savings, or the need to attract global talent, businesses in London, Manchester, Birmingham, and beyond are embracing flexible work models.
                                    </p>
                                        ...
                                        <div className="panel vstack justify-center gap-4 h-100">
                                            <div>
                                                <div className="panel vstack gap-2">
                                                    <h3 className="h4 lg:h2 m-0">Why Remote Working Matters for UK</h3>
                                                    <p className="fs-6 lg:fs-5 opacity-70 dark:opacity-80">
                                                   Over 60% of UK employees now prefer hybrid or fully remote roles, and companies that adapt to this trend see improved retention and morale. Remote working offers a way to reduce overhead costs like office rent while tapping into a broader talent pool. However, the shift to remote work isn’t without challenges—security risks, communication gaps, and tech hiccups can derail even the best teams. That’s where our expert IT support comes in.
                                                    </p>
