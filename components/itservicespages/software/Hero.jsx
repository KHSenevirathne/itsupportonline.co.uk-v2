                        ...
                        <div className="row child-cols-12 lg:child-cols-6 col-match items-center g-0">
                            <div data-anime="onview: -100; translateX: [-48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: 100;">
                                <figure className="featured-image m-0 rounded ratio ratio-1x1 overflow-hidden rounded-1-5 lg:rounded-2 lg:rounded-bottom-end-0">
                                    <Image
                                        ...
                                        alt="image title"
                                        src="/assets/images/template/services-11.webp"
                                        width="1200"
                                        height="1200"
                                    />
                                </figure>
                            ...
                            <div data-anime="onview: -100; translateX: [48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: 200;">
                                ...
                                >
                                    ...
                                    In a competitive business landscape, having the right software can give you a significant edge. At ClickDo IT, our Software Development and Maintenance service provides custom solutions to meet your unique business needs, along with ongoing support to ensure your applications perform flawlessly. Whether you need a new application or updates to existing software, we’ve got you covered.
                                    </p>
                                ...
                                <div className="row child-cols col-match justify-between g-4 lg:g-8 xl:g-10">
                                    <div className="order-0 lg:order-1">
                                        <div className="panel w-100 rounded lg:rounded-2 overflow-hidden">
                                            <Image
                                                src="/assets/images/template/services-11-inner.webp"
                                                width={780}
                                                height={728}
                                        ...
                                        <div className="panel vstack justify-center gap-4 h-100">
                                            <div>
                                                <div className="panel vstack gap-2">
                                                    ...
                                                    Security is a top priority in our Software Development and Maintenance service. We follow strict coding standards to protect your applications from vulnerabilities, and we conduct thorough testing to identify and address potential issues before deployment. Our team also ensures that your software complies with relevant regulations, such as data protection laws, to keep your business compliant.
                                                    </p>
