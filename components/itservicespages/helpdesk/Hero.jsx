                        ...
                        <div className="row child-cols-12 lg:child-cols-6 col-match items-center g-0">
                            <div data-anime="onview: -100; translateX: [-48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: 100;">
                                <figure className="featured-image m-0 rounded ratio ratio-1x1 overflow-hidden rounded-1-5 lg:rounded-2 lg:rounded-bottom-end-0">
                                    <Image
                                        ...
                                        alt="image title"
                                        src="/assets/images/template/services-08.webp"
                                        width="1200"
                                        height="1200"
                                    />
                                </figure>
                            ...
                            <div data-anime="onview: -100; translateX: [48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: 200;">
                                ...
                                >
                                    ...
                                    Our Help Desk Support service offers 24/7 access to a team of skilled IT professionals who are ready to resolve your technical issues promptly. We provide both remote and on-site support, depending on the nature of the problem, ensuring minimal downtime for your business. From troubleshooting software errors to assisting with password resets, our team handles a wide range of IT challenges, allowing your employees to focus on their core responsibilities rather than technical frustrations.
                                    </p>
                                        ...
                                        <div className="panel vstack justify-center gap-4 h-100">
                                            <div>
                                                <div className="panel vstack gap-2">
                                                    {/* <h3 className="h4 lg:h2 m-0">The Role of IT Support London</h3> */}
                                                    <p className="fs-6 lg:fs-5 opacity-70 dark:opacity-80">
                                                    Our Help Desk Support is ideal for businesses of all sizes, from small startups to large enterprises. We pride ourselves on delivering exceptional customer service, with a focus on quick response times and effective solutions. With IT Support, you can rest assured that your IT support needs are in capable hands, allowing you to focus on growing your business.
                                                    </p>
