                        ...
                        <div className="row child-cols-12 lg:child-cols-6 col-match items-center g-0">
                            <div data-anime="onview: -100; translateX: [-48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: 100;">
                                <figure className="featured-image m-0 rounded ratio ratio-1x1 overflow-hidden rounded-1-5 lg:rounded-2 lg:rounded-bottom-end-0">
                                    <Image
                                        ...
                                        alt="image title"
                                        src="/assets/images/template/services-04.webp"
                                        width="1200"
                                        height="1200"
                                    />
                                </figure>
                            ...
                            <div data-anime="onview: -100; translateX: [48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: 200;">
                                ...
                                >
                                    ...
                                    In the era of digital transformation, cloud computing has emerged as a game-changer for businesses of all sizes. At IT Support Online, we specialize in offering comprehensive cloud services that empower your business with flexibility, scalability, and efficiency.
                                    </p>
                                ...
                                <div className="row child-cols col-match justify-between g-4 lg:g-8 xl:g-10">
                                    <div className="order-0 lg:order-1">
                                        <div className="panel w-100 rounded lg:rounded-2 overflow-hidden">
                                            <Image
                                                src="/assets/images/template/services-04-inner.webp"
                                                width={780}
                                                height={728}
                                        ...
                                        <div className="panel vstack justify-center gap-4 h-100">
                                            <div>
                                                <div className="panel vstack gap-2">
                                                    <h3 className="h4 lg:h2 m-0">Why Opt for IT Support Online’s Cloud Services?</h3>
                                                    <p className="fs-6 lg:fs-5 opacity-70 dark:opacity-80">
                                                        At IT Support London, our approach to managed IT services is tailored to the specific needs of each client. We understand that every business is unique, and our services are designed to align seamlessly with your operational goals. Our team of experts is committed to delivering:
                                                    </p>
