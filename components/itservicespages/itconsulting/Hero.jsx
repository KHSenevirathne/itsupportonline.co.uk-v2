                            ...
                            <div data-anime="onview: -100; translateX: [-48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: 100;">
                                <figure className="featured-image m-0 rounded ratio ratio-1x1 overflow-hidden rounded-1-5 lg:rounded-2 lg:rounded-bottom-end-0">
                                    <Image
                                        ...
                                        alt="image title"
                                        src="/assets/images/template/services-07.webp"
                                        width="1200"
                                        height="1200"
                                    />
                                </figure>
                            ...
                            <div data-anime="onview: -100; translateX: [48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: 200;">
                                ...
                                >
                                    <h3 className="h3 lg:h2 m-0">
                                        An Entire Managed IT Team at Your Side
                                    </h3>
                                    <p className="fs-6 lg:fs-5">
                                        In the rapidly evolving world of technology, staying ahead of the curve is crucial for any business. That’s where ITSupportOnline.co.uk comes in, offering comprehensive IT Consulting Services tailored to your unique needs. Our team of experienced professionals is dedicated to ensuring that your IT infrastructure is not only robust but also agile enough to adapt to the ever-changing technological landscape.
                                    </p>
                                ...
                                <div className="row child-cols col-match justify-between g-4 lg:g-8 xl:g-10">
                                    <div className="order-0 lg:order-1">
                                        <div className="panel w-100 rounded lg:rounded-2 overflow-hidden">
                                            <Image
                                                src="/assets/images/template/services-07-inner.webp"
                                                width={780}
                                                height={728}
                                        ...
                                        <div className="panel vstack justify-center gap-4 h-100">
                                            <div>
                                                <div className="panel vstack gap-2">
                                                    <h3 className="h4 lg:h2 m-0">Why Choose ITSupport.co.uk?</h3>
                                                    <p className="fs-6 lg:fs-5 opacity-70 dark:opacity-80">
                                                        Choose ITSupport.co.uk for IT Consulting Services that are as unique as your business. Let us help you harness the power of technology to drive your business forward.
                                                    </p>
